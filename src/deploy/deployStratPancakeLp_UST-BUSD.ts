...
const stratName = 'StratPancakeLp_UST-BUSD'
const lpToken = '0x05faf555522Fa3F93959F86B41A3808666093210' // only mainnet address needed
const token = '0x23396cf899ca06c4472205fc903bdb4de249d6fc' // only mainnet address needed
const pid = 293 // MasterChef pool ID
