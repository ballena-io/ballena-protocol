...
const stratName = 'StratPancakeLp_BUSD-BNB'
const lpToken = '0x58F876857a02D6762E0101bb5C46A8c1ED44Dc16' // only mainnet address needed
const pid = 252 // MasterChef pool ID
...
const deploy: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const cakeToToken1Path = [cake, wbnb]
