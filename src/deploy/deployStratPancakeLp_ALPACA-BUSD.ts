...
const stratName = 'StratPancakeLp_ALPACA-BUSD'
const lpToken = '0x7752e1FA9F3a2e860856458517008558DEb989e3' // only mainnet address needed
const token = '0x8f0528ce5ef7b51152a59745befdd91d97091d2f' // only mainnet address needed
const pid = 362 // MasterChef pool ID
