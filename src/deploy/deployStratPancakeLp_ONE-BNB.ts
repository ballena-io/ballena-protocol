...
const stratName = 'StratPancakeLp_ONE-BNB'
const lpToken = '0x9D2296e2Fe3CdBf2EB3e3e2CA8811BaFA42eeDFF' // only mainnet address needed
const token = '0x03ff0ff224f904be3118461335064bb48df47938' // only mainnet address needed
const pid = 427 // MasterChef pool ID
