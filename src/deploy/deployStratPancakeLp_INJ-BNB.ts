...
const deploy: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const inj = '0xa2b726b1145a4773f68593cf171187d8ebe4d495' // only mainnet address needed
  const pid = 270 // MasterChef pool ID
  const addresses = [
    '0x1bdcebca3b93af70b58c41272aea2231754b23ca', // LP Token address
    wbnb,
    inj,
    cake,
  ...
  const cakeToToken1Path = [cake, wbnb, inj]

  await deploy('StratPancakeLp_INJ-BNB', {
...
deploy.tags = ['StratPancakeLp_INJ-BNB']
