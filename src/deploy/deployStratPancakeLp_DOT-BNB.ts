...
const deploy: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const dot = '0x7083609fce4d1d8dc0c979aab8c869ea2c873402' // only mainnet address needed
  const pid = 255 // MasterChef pool ID
  const addresses = [
    '0xDd5bAd8f8b360d76d12FdA230F8BAF42fe0022CF', // LP Token address
    wbnb,
    dot,
    cake,
  ...
  const cakeToToken1Path = [cake, wbnb, dot]

  await deploy('StratPancakeLp_DOT-BNB', {
...
deploy.tags = ['StratPancakeLp_DOT-BNB']
