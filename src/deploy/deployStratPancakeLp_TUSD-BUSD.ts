...
const deploy: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const tusd = '0x14016e85a25aeb13065688cafb43044c2ef86784' // only mainnet address needed
  const pid = 397 // MasterChef pool ID
  const addresses = [
    '0x2e28b9b74d6d99d4697e913b82b41ef1cac51c6c', // LP Token address
    busd,
    tusd,
    cake,
  ...
  const cakeToToken1Path = [cake, busd, tusd]

  await deploy('StratPancakeLp_TUSD-BUSD', {
...
deploy.tags = ['StratPancakeLp_TUSD-BUSD']
