...
const stratName = 'StratPancakeLp_SKILL-BNB'
const lpToken = '0xC19dfd34D3ba5816dF9CBDaa02D32A9F8dc6F6fC' // only mainnet address needed
const token = '0x154a9f9cbd3449ad22fdae23044319d6ef2a1fab' // only mainnet address needed
const pid = 434 // MasterChef pool ID
