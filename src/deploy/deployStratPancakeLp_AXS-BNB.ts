...
const stratName = 'StratPancakeLp_AXS-BNB'
const lpToken = '0xC2d00De94795e60FB76Bc37d899170996cBdA436' // only mainnet address needed
const token = '0x715d400f88c167884bbcc41c5fea407ed4d2f8a0' // only mainnet address needed
const pid = 430 // MasterChef pool ID
