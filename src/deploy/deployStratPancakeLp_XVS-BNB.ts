...
const stratName = 'StratPancakeLp_XVS-BNB'
const lpToken = '0x7eb5d86fd78f3852a3e0e064f2842d45a3db6ea2' // only mainnet address needed
const token = '0xcf6bb5389c92bdda8a3747ddb454cb7a64626c63' // only mainnet address needed
const pid = 260 // MasterChef pool ID
